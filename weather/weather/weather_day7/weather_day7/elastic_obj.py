...
class ElasticObj:
    def __init__(self, index_name, index_type, ip=('192.168.23.101',)):
        """
        ...
        self.es = Elasticsearch(list(ip), http_auth=('es', '10trg0729'), port=9200)
